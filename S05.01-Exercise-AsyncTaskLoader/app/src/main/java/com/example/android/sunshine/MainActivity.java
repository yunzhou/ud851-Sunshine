...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int SEARCH_QUERY_LOCATION_LOADER = 23;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loader<String[]> weatherLoader = getSupportLoaderManager().getLoader(SEARCH_QUERY_LOCATION_LOADER);
        if (weatherLoader == null) {
            getSupportLoaderManager().initLoader(SEARCH_QUERY_LOCATION_LOADER, null, this);
        }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            String[] mWeatherResult=null;
            @Override
            public String[] loadInBackground() {
                Log.d("Sunshine","loadInBackground");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(SEARCH_QUERY_LOCATION_LOADER, null, this);
            return true;
        }
